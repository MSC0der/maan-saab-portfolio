  ...
  protected readonly panels: readonly ExpertisePanel[] = [
    {
      ...
      skills: ['Node.js', 'Express.js', 'REST APIs', 'Middleware', 'Auth', 'RBAC', 'API Security'],
    },
    {
      title: 'Frontend Engineering',
      imageAlt: 'Frontend architecture visualization',
      imageUrl:
        '/images/about/frontend_engineering_technical_architecture.png',
      skills: ['Angular', 'TypeScript', 'RxJS', 'Responsive UI', 'Component Architecture'],
    },
    {
      ...
      skills: ['MongoDB', 'MySQL', 'Query Optimization', 'Schema Design', 'Data Modeling'],
    },
    {
      title: 'Cloud & Dev Tools',
      imageAlt: 'Engineering toolkit visualization',
      imageUrl:
        '/images/about/cloud_dev_tools.png',
    ...
    },
    {
      ...
      imageUrl:
        '/images/about/sofware_engineering_techincal_architecture.png',
      skills: ['Debugging', 'Optimization', 'Problem Solving', 'Clean Architecture', 'Scalability'],
    },
    {
      title: 'Problem Solving & DSA',
      imageAlt: 'Algorithm roadmap dashboard',
      imageUrl:
        '/images/about/problem_solving_dsa.png',
      skills: ['Arrays', 'Binary Search', 'Sliding Window', 'Trees', 'Graphs', 'Dynamic Programming'],
    },
  ];
}
