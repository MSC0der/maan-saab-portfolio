...
@Component({
  selector: 'app-about-expertise-wayne',
  standalone: true,
  imports: [],
  templateUrl: './about-expertise-wayne.component.html',
  styleUrl: './about-expertise-wayne.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AboutExpertiseWayneComponent {
