...
@Component({
  ...
  standalone: true,
  imports: [HomeHeroActionsComponent, HomeHeroVisualComponent, HomeTechChipComponent],
  templateUrl: './home-hero.component.html',
  styleUrl: './home-hero.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class HomeHeroComponent {
  protected readonly technologies = ['Node.js', 'Angular', 'MongoDB', 'MySQL', 'TypeScript'];
